...
// From https://github.com/DotNetAnalyzers/StyleCopAnalyzers/blob/master/StyleCop.Analyzers/StyleCopTester/CodeFixEquivalenceGroup.cs
...
namespace StyleCopTester
{
    ...
    internal class CodeFixEquivalenceGroup
    {
        ...
        internal async Task<ImmutableArray<CodeActionOperation>> GetOperationsAsync(CancellationToken cancellationToken)
        {
            ...
            var context = new FixAllContext(document, this.CodeFixProvider, FixAllScope.Project, this.CodeFixEquivalenceKey, diagnosticIds, diagnosticsProvider, cancellationToken);
